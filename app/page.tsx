  ...
  const expertiseItems = [
    {
      ...
      description:
        "Proven entrepreneurial success with MyTracks, turning innovative ideas into impactful solutions."
    },
    {
      title: "Creative Problem-Solving",
      description:
        "A creative hacker mindset, adept at finding unconventional solutions to challenging problems."
    },
    {
      title: "Data-Driven Decision Making",
      description:
        "Transforming raw data into actionable insights, enhancing efficiency across industries."
    },
    {
      title: "Artificial Intelligence",
      description:
        "Leveraging AI and machine learning to streamline complex decision-making in multiple sectors."
    },
    {
      title: "SEO & Digital Marketing",
      description:
        "Exceptional skills in SEO, driving traffic, and optimizing visibility for tech startups."
    },
    {
      title: "Team Building & Leadership",
      description:
        "Skilled at attracting and retaining top talent to build high-performing teams."
    }
  ]
          ...
          <div className="container px-4 md:px-6">
            {mounted ? (
              ...
              >
                ...
                <p className="text-muted-foreground">
                  His unique approach combines technical excellence with strategic thinking, allowing him to bridge the gap between complex technological concepts and practical business applications. Specializing in Entrepreneurship, creative data applications and SEO. Known for assembling top-tier teams, he’s the kind of creative hacker who figures out how to make things happen.
                </p>
              </motion.div>
            ) : (
              <div className="space-y-8 max-w-3xl mx-auto">
                ...
                <p className="text-muted-foreground">
                  Hugo Real is a French tech entrepreneur, born in Toulouse in 1998.
                </p>
              </div>
            )}
          </div>
          ...
          <div className="container px-4 md:px-6">
            {mounted ? (
              ...
              <div className="text-center mb-10 max-w-3xl mx-auto">
                ...
                <p className="text-muted-foreground mb-8">
                  Hugo Real co-founded MyTracks, a groundbreaking startup set on revolutionizing the second-hand car market.
                </p>
              </div>
            )}
          </div>
          ...
          <div className="container px-4 md:px-6">
            {mounted ? (
              ...
              <div className="max-w-3xl mx-auto text-center space-y-4">
                <h2 className="text-3xl font-bold tracking-tighter">The Vision</h2>
                <p className="text-muted-foreground">
                  Hugo Real envisions a future where technology serves humanity.
                </p>
              </div>
            )}
          </div>
